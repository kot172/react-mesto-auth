...
const currentUser = useContext(CurrentUserContext)
    ...
    <section className="profile">
      <div className="profile__capture">
        ...
        <img className="profile__avatar" src={currentUser.avatar ? currentUser.avatar : '#'} alt="аватарка" />
      </div>
      ...
      <button type="button" aria-label="add" className="profile__rectangle" onClick={onAddPlace} />
    </section>
